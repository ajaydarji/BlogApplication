  ...
  return (
    <div className="container mx-auto my-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 p-6">
      {blogs.length > 0 ? (
          ...
          >
            <div className="group relative">
              <img
                ...
                alt={`Image for ${element.title}`} // Adding meaningful alt text
            ...
            <div className="p-6 flex items-center">
              <img
                ...
                alt={`${element.adminName}'s profile`} // Adding meaningful alt text
        ...
        <div className="flex h-screen items-center justify-center">
          <p>No blogs available.</p> {/* Added message for no blogs */}
        </div>
      )}
    </div>
  );
